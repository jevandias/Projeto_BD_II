...
public class CadastroFuncionario extends JFrame {
	...
	public CadastroFuncionario() {
		...
		btnInici.setForeground(Color.WHITE);
		btnInici.setBorder(null);
		btnInici.setBackground(new Color(0, 168, 89));
		btnInici.setBounds(37, 349, 57, 23);
		...
		btnCadastroDepartamentos.setForeground(Color.WHITE);
		btnCadastroDepartamentos.setBorder(null);
		btnCadastroDepartamentos.setBackground(new Color(0, 168, 89));
		btnCadastroDepartamentos.setBounds(37, 371, 162, 23);
