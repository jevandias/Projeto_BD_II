...
public class Inicio extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jTable1.setModel(
			...
			new String[] {
				"CPF", "Nome", "Telefone", "Departamento"
			}
		));
		...
		Dependentes = new JPanel();
		Dependentes.setBackground(Color.WHITE);
		jTabbedPane1.addTab("Dependentes", null, Dependentes, null);
		Dependentes.setLayout(null);
		...
		Dependentes.add(lblCadastroDeDependentes);
